...
if (isset($_POST['submit'])) {
  ...
  $tempname = $_FILES["fileupload"]["tmp_name"];    
    ...
    header("location:slider.php");
      ...
      $sql = "update image set image='$filename', link='$link' where id='$id' ";
                    ...
                    <form action="<?php echo $_SERVER['PHP_SELF'];?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="card-body card-block">
                            <div class="form-group">
                              ...
                              <input type="text" id="link" name="id" class="form-control" value="<?php echo $row['id'] ?>">
                              
                                     
                           </div>
                              <label for="Categories" class=" form-control-label">Name</label>
                              <input type="file" id="fileupload" name="fileupload" class="form-control" value="<?php echo $row['img'] ?>" /><img class="d-block w-25" src="../img/<?php echo $row['image']?>" alt="Second slide">
                           </div>
                              <label for="Categories" class=" form-control-label">Link</label>
